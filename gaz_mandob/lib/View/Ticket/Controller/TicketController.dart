...
import 'package:gaz_mandob/Model/Message.dart';
import 'package:gaz_mandob/Model/Ticket.dart';
...
// To display messages ordered by `createdAt`, you can sort the messages list
// before calling `notifyListeners()` in your `GetMessageTicket` method.
