...
class EditProduct extends StatelessWidget {
  EditProduct({this.subCategory, this.category});
  Category? category;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Gap(20),
                  CheckBoxCustom(
                    check: controller.showpromocode,
                    onChanged: (value) => controller.changepromocode(value!),
                  )
                ],
              ),
              Gap(10),
                        ...
                        Expanded(
                          child: TextInputCustom(
                            ...
                            icon: GestureDetector(
                                onTap: () =>
                                    controller.showDialogTimeFrom(context),
                      ...
                      children: [
                        ...
                        Expanded(
                          child: TextInputCustom(
                            ...
                            icon: GestureDetector(
                                onTap: () =>
                                    controller.showDialogTimeTo(context),
                                child: Icon(Icons.av_timer_outlined)),
                          ),
                        ),
                      ],
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () async {
                    EasyLoading.show();
                    try {
                      var result = await controller.EditProduct(
