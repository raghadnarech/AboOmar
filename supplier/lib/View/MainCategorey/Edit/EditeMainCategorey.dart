...
class EditeMainCategorey extends StatelessWidget {
  EditeMainCategorey({this.category});
  Category? category;
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: Consumer<EditMainCategoryController>(
          builder: (context, controller, child) => ListView(
              ...
              children: [
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: FadeInImage.assetNetwork(
                                    ...
                                    image:
                                        "${AppApi.IMAGEURL}${category!.image}",
                                    width: 100,
                                    height: 100,
                                    imageErrorBuilder:
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      controller.EditMainCategory(context);
                    },
                    child: Container(
