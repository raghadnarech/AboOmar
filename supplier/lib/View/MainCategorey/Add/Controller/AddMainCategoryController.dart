...
class AddMainCategoryController with ChangeNotifier {
  TextEditingController namecontroller = TextEditingController();
  @override
  void dispose() {
    namecontroller.clear();
    log("close add main category page");
    super.dispose();
  }
  ...
  Future<Either<Failure, bool>> AddMainCategory(
    ...
    try {
      ...
      if (connected) {
        ...
        if (response.statusCode == 200) {
          EasyLoading.dismiss();
          CustomDialog.Dialog(context, title: "تم إضافة التصنيف الرئيسي بنجاح");

          CustomRoute.RouteAndRemoveUntilTo(
              context,
              ChangeNotifierProvider<MainPageController>(
                create: (context) => MainPageController()..GetMainCategory(),
