...
class AddSubCategoryController with ChangeNotifier {
  ...
  Future<Either<Failure, bool>> AddSubCategory(
    ...
    try {
      ...
      if (connected) {
        ...
        if (response.statusCode == 200) {
          EasyLoading.dismiss();
          CustomDialog.Dialog(context, title: "تم إضافة التصنيف الفرعي بنجاح");
