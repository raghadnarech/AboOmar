              ...
              children: [
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text("رقم الفاتورة", style: style18semibold),
                        const Gap(5),
                        Text(
                ...
                const Gap(20),
                controller.order.order?.invoices?.isEmpty ?? true
                    ? Container()
                    : SingleChildScrollView(
                      ...
                      child: DataTable(
                        columns: [
                          DataColumn(
                            label: Text("المنتج", style: style18semibold),
                          ),
                          DataColumn(
                            label: Text("القيمة", style: style18semibold),
                          ),
                          DataColumn(
                            label: Text("الكمية", style: style18semibold),
                          ),
                          DataColumn(
                            label: Text('الإجمالي', style: style18semibold),
                          ),
                        ],
                        rows:
                            controller.order.order!.invoices!
                                .expand(
                                  (invoice) => invoice.products!.map(
                                    (product) => DataRow(
                                      cells: [
                                        DataCell(
                                          Text(
                ...
                Row(
                  children: [
                    Text("عنوان التوصيل", style: style18semibold),
                    const Gap(10),
                    // Row(
                    //   children: [
                    ...
                    //                 (e) =>
                    //                     e.id ==
                    //                     controller.order.order!.addressId,
                    //               )
                    //               .name ??
                    //           "غير محدد",
                    //       style: style15semibold,
                ...
                Row(
                  children: [
                    Text("تاريخ الطلب", style: style18semibold),
                    const Gap(10),
                    Text(
                ...
                Row(
                  children: [
                    Text("السعر الصافي", style: style18semibold),
                    const Gap(10),
                    Text(
                ...
                controller.order.order!.toDoor == '1'
                    ? Row(
                      children: [
                        Text("رسوم التوصيل", style: style18semibold),
                        const Gap(10),
                        Text(
                ...
                Row(
                  ...
                  children: [
                    Text("السعر مع الرسوم", style: style18semibold),
                    const Gap(10),
                    Text(
                ...
                controller.order.order!.status == 'pending'
                    ? GestureDetector(
                      onTap: () {
                        ...
                        CustomRoute.RouteTo(
                          context,
                          TrackOrder(id: controller.order.order!.id),
                        );
                      },
                      child: Container(
                        height: 43,
